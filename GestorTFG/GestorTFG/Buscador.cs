...
namespace GestorTFG
{
    ...
    class Buscador
    {
        ...
        private bool FiltrarProyecto(int index1, int index2, int index3, int index4, DateTimePicker date1, DateTimePicker date2, DateTimePicker date3, NumericUpDown number)
        {
            bool resul = true;
