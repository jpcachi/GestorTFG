...
namespace GestorTFG2
{
    ...
    {
        private static List<CustomListView> listViews = new List<CustomListView>();
        public static List<CustomListView> Listas
        {
            get
            {
                return listViews;
        ...
        {
            foreach (CustomListView vista in listViews)
        ...
        public static void DibujarSubItemListViewBusqueda(TCampos campo, string clave, object sender, DrawListViewSubItemEventArgs e)
        {
            ...
            else if ((e.SubItem.Text.ToUpperInvariant().Contiene(clave.ToUpperInvariant()) && campo == TCampos.Todos && e.ColumnIndex != Constantes.COLUMNA_CONVOCATORIA && e.ColumnIndex != Constantes.COLUMNA_FECHA_REGISTRO && e.ColumnIndex != Constantes.COLUMNA_ALUMNO_FECHA_INICIO && e.ColumnIndex != Constantes.COLUMNA_FECHA_DEFENSA) || (e.SubItem.Text.ToUpperInvariant().Contiene(clave.ToUpperInvariant()) && campo == TCampos.Titulo && e.ColumnIndex == 0) || (e.SubItem.Text.ToUpperInvariant().Contiene(clave.ToUpperInvariant()) && campo == TCampos.Descripcion && e.ColumnIndex == 1) || (e.SubItem.Text.ToUpperInvariant().Contiene(clave.ToUpperInvariant()) && campo == TCampos.Alumno && (e.ColumnIndex == 3 || e.ColumnIndex == 4 || e.ColumnIndex == 5 || e.ColumnIndex == 6)))
            {
